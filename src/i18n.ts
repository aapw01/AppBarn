...
export const messages = {
  en: {
    ...
    footer: {
      tagline: 'AppBarn — A curated showcase of indie apps & system tools.',
    },
    common: {
      app: 'App',
      system: 'System',
    ...
    submit: {
      ...
      subtitle: 'Share your app or system tool with the community.',
      ...
      errors: {
        ...
        invalidType: 'Invalid type. Must be "app" or "system"',
  ...
  zh: {
    ...
    submit: {
      ...
      errors: {
        ...
        invalidType: '无效类型，必须是 app 或 system',
